...
childcare = float(input("Childcare: \n"))
family_activities = float(input('Family activities: \n'))
...
fixed_exp = rent + insurance + car_payment + utilities
